import { useGetProductDetailsQuery, useCreateProductReviewMutation } from '../slices/productsApiSlices.js';
...
const ProductScreen = () => {
  ...
  const addToCartHandler = () => {
    ...
    navigate('/cart');  // Ensure navigation happens after dispatch
  };
